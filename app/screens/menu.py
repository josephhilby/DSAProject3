    ...
    def render(self):
        if self.header_section is None:
            self.header_section = pygame_gui.elements.UILabel(
                ...
                text=MENU_TXT,
                relative_rect=pygame.Rect(SCREEN_WIDTH * 0.0,
                                          SCREEN_HEIGHT * 0.0,
                                          SCREEN_WIDTH * 1.0,
                                          SCREEN_HEIGHT * 0.05)
            )
        ...
        if self.dropdown_section is None:
            ...
            self.alg_one_dropdown = pygame_gui.elements.UIDropDownMenu(
                ...
                relative_rect=pygame.Rect(SCREEN_WIDTH * 0.35,
                                          SCREEN_HEIGHT * 0.42,
                                          110,
                                          25)
            )
            ...
            self.alg_two_dropdown = pygame_gui.elements.UIDropDownMenu(
                ...
                options_list=self.alg_names(),
                starting_option=self.alg_names()[0],
                relative_rect=pygame.Rect(SCREEN_WIDTH * 0.55,
                                          SCREEN_HEIGHT * 0.42,
                                          110,
                                          25)
            )
        ...
        if self.start_button is None:
            self.start_button = pygame_gui.elements.UIButton(
                manager=self.manager,
                text='Start',
                relative_rect=pygame.Rect(SCREEN_WIDTH * 0.72,
                                          SCREEN_HEIGHT * 0.9,
                                          SCREEN_WIDTH * 0.08,
                                          SCREEN_HEIGHT * 0.08)
            )
        ...
        if self.exit_button is None:
            self.exit_button = pygame_gui.elements.UIButton(
                manager=self.manager,
                text='Quit',
                relative_rect=pygame.Rect(SCREEN_WIDTH * 0.85,
                                          SCREEN_HEIGHT * 0.9,
                                          SCREEN_WIDTH * 0.08,
                                          SCREEN_HEIGHT * 0.08)
            )
